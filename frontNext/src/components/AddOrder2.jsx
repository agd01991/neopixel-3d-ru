...
<div className='text-white flex mx-auto  p-[10px] justify-center laptop:max-w-7xl laptop:mb-[140px]'>
    <div className='text-lg text-white font-HelveticaNeueCyr font-semibold text-center mb-6 laptop:text-5xl' name="orderR">ОФОРМИТЬ ПРЕДЗАКАЗ НА ПРИНТЕР RUBY</div>
</div>
