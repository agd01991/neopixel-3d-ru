...
export default function DescriptionPrint() {
    return (
        <div className=' w-full bottom-[170px] z-10 bg-[#1E1F21] pb-[20px] laptop:absolute laptop:bottom-[170px] laptop:bg-transparent '>
            <div className='flex text-center laptop:text-start laptop:max-w-7xl laptop:mx-auto'>
                <div className='pt-[200px] pr-[300px]'>
                    <h1 className='uppercase text-white text-lg font-semibold laptop:text-6xl max-w-[300px]'>NeoPixel <span className='text-[#FFD701]'>Heliodorus</span></h1>
                ...
                <div className='flex-colomn space-y-5'>
                    <div className=" bg-[#171616] w-[300px] h-[200px] rounded-lg ">
                        <Image className='w-[118px] h-[123px] mx-auto laptop:w-[140px] laptop:h-[150px]' src={require('../../assets/printers/firstPrinter.png')} alt="p1" />
                        <div className='text-white pl-[30px]'><Link href="/Printers/PrinterR">Смотреть</Link></div>
                    </div>
                    <div className="bg-[#171616] w-[300px] h-[200px] rounded-lg">
